...
class SnapmapArchiver:
    ...
    def download_snaps(self, group: list[Snap] | Snap):
        ...
        for snap in group:
            ...
            if os.path.isfile(fpath):
                ...
                os.utime(fpath, (isoparse(snap.create_time).astimezone().timestamp(), isoparse(snap.create_time).timestamp()))
                continue
    ...
    def _parse_snap(
        ...
        if snap["snapInfo"].get("snapMediaType"):
            ...
            data_dict["snapMediaInfo"] = snap["snapInfo"].get("snapMediaType")
            data_dict["duration"] = snap.get("duration")
        elif snap["snapInfo"].get("streamingMediaInfo"):
            data_dict["file_type"] = "jpg"
            data_dict["snapMediaInfo"] = "JPEG"
            data_dict["duration"] = snap.get("duration")
        else:
            print(
